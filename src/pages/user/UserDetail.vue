<template>
  <v-card>
    ...
    <v-container class="d-flex">
      ...
      <div class="user-detail ml-8" v-for="user in userDetail" :key="user.id">
        <div class="detail-list px-2 py-2">
          <span class="detail-text"> ID : </span>
        ...
        <div class="detail-list px-2 py-2">
          <span class="detail-text"> Dob : </span>
